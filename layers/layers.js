...
lyr_ne_10m_airports_1.set('fieldAliases', {'scalerank': 'scalerank', 'featurecla': 'featurecla', 'type': 'type', 'name': 'Nome', 'abbrev': 'abbrev', 'location': 'location', 'gps_code': 'gps_code', 'iata_code': 'iata_code', 'wikipedia': 'URL', 'natlscale': 'natlscale', 'Type': 'Type', });
...
lyr_ne_10m_airports_1.set('fieldLabels', {'type': 'hidden field', 'name': 'no label', 'iata_code': 'header label - always visible', 'wikipedia': 'no label', 'Type': 'no label', });
